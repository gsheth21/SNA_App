    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(
          ...
          box(
            ...
            solidHeader = TRUE,
            status = "info",
            plotlyOutput("community_size_dist", height = "300px")
          )
        )
      ),
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status = "info",
          visNetworkOutput("community_plot", height = "500px")
        )
      ),
    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(
          ...
          box(
            ...
            solidHeader = TRUE,
            status = "info",
            plotlyOutput("clique_size_dist", height = "300px")
          )
        )
      ),
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status = "info",
          visNetworkOutput("cliques_plot", height = "500px")
        )
      )
    ),
    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(
          ...
          box(
            ...
            solidHeader = TRUE,
            status = "info",
            plotlyOutput("kcore_distribution", height = "300px")
          )
        )
      ),
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status = "info",
          visNetworkOutput("kcores_plot", height = "500px")
        )
      ),
