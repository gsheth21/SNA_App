...
source(here::here("onemode", "server", "overview_server.R"))
source(here::here("onemode", "server", "networks_server.R"))
source(here::here("onemode", "server", "connectivity", "connectivity_server.R"))
source(here::here("onemode", "server", "centrality_server.R"))
source(here::here("onemode", "server", "communities_server.R"))
source(here::here("onemode", "server", "assortativity_server.R"))
source(here::here("onemode", "server", "roles_server.R"))
source(here::here("onemode", "server", "simulation_server.R"))
