      ...
      fluidRow(
        column(
          ...
          box(
            ...
            width = NULL,
            solidHeader = TRUE,
            withSpinner(visNetworkOutput("builtin_plot", height = "500px"), color = "#CC0000", type = 4)
          )
        ),
        column(
          width = 4,
      ...
      fluidRow(
        column(
          ...
          box(
            ...
            width = NULL,
            solidHeader = TRUE,
            withSpinner(visNetworkOutput("sw_plot", height = "500px"), color = "#CC0000", type = 4)
          )
        ),
        column(
          width = 4,
      ...
      fluidRow(
        column(
          ...
          box(
            ...
            withSpinner(visNetworkOutput("ba_plot", height = "500px"), color = "#CC0000", type = 4)
          )
        ),
        column(
          width = 4,
          box(
            ...
            width = NULL,
            solidHeader = TRUE,
            withSpinner(plotlyOutput("ba_degree_dist", height = "300px"), color = "#CC0000", type = 4),
            hr(),
      ...
      fluidRow(
        column(
          ...
          box(
            ...
            withSpinner(visNetworkOutput("rw_plot", height = "500px"), color = "#CC0000", type = 4)
          )
        ),
        column(
          width = 4,
