    ...
    tabPanel(
      ...
      fluidRow(
        box(
          ...
          status      = "info",
          tabsetPanel(
            id = "equiv_viz_tabs", selected = "ggraph",
            tabPanel("ggraph",      value = "ggraph",      br(), withSpinner(plotOutput("equiv_demo_ggraph",      height = "420px"), color = "#CC0000", type = 4)),
            tabPanel("Interactive", value = "interactive", br(), withSpinner(visNetworkOutput("equiv_demo_plot", height = "420px"), color = "#CC0000", type = 4))
          )
        ),
        box(
    ...
    tabPanel(
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status      = "info",
          withSpinner(plotlyOutput("similarity_heatmap", height = "500px"), color = "#CC0000", type = 4)
        ),
        box(
    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(
          ...
          box(title = "📈 Elbow Plot (choose optimal k)", width = NULL,
              solidHeader = TRUE, status = "info",
              withSpinner(plotlyOutput("elbow_plot", height = "300px"), color = "#CC0000", type = 4))
        )
      ),
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status      = "info",
          withSpinner(visNetworkOutput("blockmodel_plot", height = "420px"), color = "#CC0000", type = 4)
        ),
        box(
          ...
          solidHeader = TRUE,
          status      = "info",
          withSpinner(plotlyOutput("permuted_matrix_plot", height = "420px"), color = "#CC0000", type = 4)
        )
      ),
