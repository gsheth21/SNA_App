    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(
          ...
          box(
            ...
            solidHeader = TRUE,
            status = "info",
            withSpinner(plotlyOutput("component_size_dist", height = "300px"), color = "#CC0000", type = 4)
          )
        )
      ),
      ...
      fluidRow(
        box(
          ...
          status = "info",
          tabsetPanel(
            id = "components_viz_tabs", selected = "ggraph",
            tabPanel("ggraph",      value = "ggraph",      br(), withSpinner(plotOutput("components_ggraph",      height = "500px"), color = "#CC0000", type = 4)),
            tabPanel("Interactive", value = "interactive", br(), withSpinner(visNetworkOutput("components_plot", height = "500px"), color = "#CC0000", type = 4))
          )
        )
      ),
    ...
    tabPanel(
      ...
      fluidRow(
        box(
          ...
          status = "info",
          tabsetPanel(
            id = "path_viz_tabs", selected = "ggraph",
            tabPanel("ggraph",      value = "ggraph",      br(), withSpinner(plotOutput("path_ggraph",      height = "500px"), color = "#CC0000", type = 4)),
            tabPanel("Interactive", value = "interactive", br(), withSpinner(visNetworkOutput("path_plot", height = "500px"), color = "#CC0000", type = 4))
          )
        )
      )
    ),
    ...
    tabPanel(
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status = "info",
          withSpinner(plotlyOutput("distance_heatmap", height = "600px"), color = "#CC0000", type = 4)
        )
      ),
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status = "info",
          withSpinner(plotlyOutput("distance_histogram", height = "400px"), color = "#CC0000", type = 4)
        )
      )
    ),
    ...
    tabPanel(
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status = "info",
          withSpinner(plotlyOutput("avg_path_length_plot", height = "400px"), color = "#CC0000", type = 4)
        )
      )
    ),
    ...
    tabPanel(
      ...
      fluidRow(
        box(
          ...
          status = "info",
          tabsetPanel(
            id = "bridges_viz_tabs", selected = "ggraph",
            tabPanel("ggraph",      value = "ggraph",      br(), withSpinner(plotOutput("bridges_ggraph",             height = "500px"), color = "#CC0000", type = 4)),
            tabPanel("Interactive", value = "interactive", br(), withSpinner(visNetworkOutput("bridges_cutpoints_plot", height = "500px"), color = "#CC0000", type = 4))
          )
        )
      ),
    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(
          ...
          box(
            ...
            solidHeader = TRUE,
            status = "info",
            withSpinner(plotlyOutput("reachable_by_distance", height = "300px"), color = "#CC0000", type = 4)
          )
        )
      ),
      ...
      fluidRow(
        box(
          ...
          solidHeader = TRUE,
          status = "info",
          withSpinner(visNetworkOutput("reachability_plot", height = "500px"), color = "#CC0000", type = 4)
        )
      )
    ),
